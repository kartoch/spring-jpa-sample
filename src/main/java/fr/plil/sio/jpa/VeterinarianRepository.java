...
public interface VeterinarianRepository {
    ...
    /**
     * /**
     * Return an veterinarian instance with specified id. Only one level dependencies are loaded (animals). if
     * dependency parameter is true.
     *
     * @param id         the id of the veterinarian to return.
     * @param dependency indicate if dependencies need to be loaded
     * @return the veterinarian instance or null if not found
     * @throws NullPointerException          if id is null
     * @throws UnsupportedOperationException in case of SQL problems
     */
    Veterinarian findOne(Long id, boolean dependency);
    ...
    public void addAnimal(Veterinarian veterinarian, Animal animal);

    public void removeAnimal(Veterinarian veterinarian, Animal animal);
}
